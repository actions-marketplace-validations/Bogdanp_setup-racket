...
- uses: Bogdanp/setup-racket@v1.15
  with:
    ...
    version: '9.3'       # or: 'stable' for the latest version, 'current' for the latest snapshot, 'pre-release' for the latest pre-release build (defaults to 'stable')
...
jobs:
  build:
    ...
    strategy:
      matrix:
        racket-version: [ '9.0', '9.1', '9.2', '9.3' ]
